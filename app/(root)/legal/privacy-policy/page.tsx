  ...
  return (
    <section
      ...
      <article className="md:w-2/3">
        ...
        <br/>
        <p>We at [Your Company Name] ("we," "our," or "us") are committed to protecting your
          privacy.
          This Privacy Policy outlines how we collect, use, and protect the personal information you
          provide to us when using {appName} (the "App").</p>
        <br/>
        <h2 className="h4-medium">1. Information We Collect</h2>
        <p>We collect the following information when you use Google Sign-In to access the App:</p>
        ...
        <ul className="list-disc pl-5">
          <li><strong>- Authentication and Account Access</strong>: To provide secure login access
            to the App and authenticate your identity.
          </li>
          <li><strong>- Personalization</strong>: To customize your experience within the App.</li>
          <li><strong>- Communication</strong>: To communicate with you about App updates, features,
            and support if necessary.
          </li>
        </ul>
        <p>
          We do not sell or share your personal information with third-party entities except as
          required for legal purposes or to fulfill the services provided by the App.</p>
        <br/>
        <h2 className="h4-medium">3. Data Retention</h2>
        <p>
          We retain your personal information for as long as your account is active or as needed to
          provide the App's services. If you wish to delete your account and associated data, you
          can contact us at <Link href={`mailto:${email}`}
        ...
        <p>
          ...
          exercise these rights, please contact us at <Link href={`mailto:${email}`}>{email}</Link>.
        </p>
        <br/>
        ...
        <p>
          <Link href="https://www.eventos-rincon.fyi/"
                className="text-blue-600 dark:text-blue-500 hover:underline"
          >
            {appName}
          </Link> <br/>
          Email: <Link href={`mailto:${email}`}
                       className="text-blue-600 dark:text-blue-500 hover:underline">{email}</Link>
        </p>
      </article>
    </section>
  );
